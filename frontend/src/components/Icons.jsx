...
export const Icon = ({ name, size = 18, className = "", color = "currentColor", ...props }) => {
  const icons = {
    ...
    drive: (
      <svg width={size} height={size} viewBox="0 0 87.3 78" className={className} {...props}>
    ...
    star: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill={props.fill || "none"} stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
    ...
    key: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
        <path d="m21 2-2 2m-1.5 1.5L16 7l-1.5-1.5L13 7l1 1-5 5a5 5 0 1 0 2 2l5-5 1 1 1.5-1.5L17 8l1.5-1.5L20 8l2-2-1-4z" />
